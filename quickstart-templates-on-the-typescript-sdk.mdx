---
title: "Example Models on TypeScript SDK"
...
Before getting started, ensure you have a set `OCTOAI_TOKEN` either as an environment variable or passed to the client. See [TypeScript SDK Installation & Setup](/docs/typescript-sdk-installation-setup) for more information.
